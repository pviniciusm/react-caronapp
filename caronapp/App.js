...
function images() {
  return day < 19  ? require('./img/morning.jpg') : require('./img/night.jpg');
}

function fontTitle() {
  return day < 19 ? {} : {color:"#FFF"}; 
}**/
        ...
        <ScrollView refreshControl={
          ...
          <ImageBackground source={this.imgDay()} style={{flexDirection:'column'}}>
            ...
            <View style={styles.buttons}>
              <TouchableOpacity style={styles.buts} onPress={() => this.changeDay()}>
                <Text style={{color:"#FFF", fontSize:18}}>Oferecer</Text>
              </TouchableOpacity>
              
              <TouchableOpacity style={styles.buts2}>
